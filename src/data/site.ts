export const site = {
  brand: "Marketing Couple",
  handle: "the.marketing.couple",
...
export const processSteps = [
  {
    ...
    detail:
      "Audience insights, competitor scans, and brand clarity before we create.",
    image:
  ...
  },
  {
    ...
    detail:
      "Content pillars, hooks, and a plan mapped to your growth goals.",
    image:
  ...
  },
  {
    ...
    icon: "file" as const,
    detail:
      "Scroll-stopping scripts and talking points built for retention.",
    image:
  ...
  },
  {
    ...
    detail:
      "Pacing, captions, and polish that feel premium on every platform.",
    image:
  ...
  },
  {
    ...
    icon: "send" as const,
    detail:
      "Smart publishing, covers, and captions that invite engagement.",
    image:
...
export const services = [
  {
    ...
    description:
      "Positioning, content pillars, and monthly plans built for organic growth.",
    image:
  ...
  },
  {
    ...
    description:
      "Visual identity and narrative that makes your brand feel memorable.",
    image:
  ...
  },
  {
    ...
    description:
      "Launch assets for product drops, offers, and always-on brand campaigns.",
    image:
  ...
  },
  {
    ...
    description:
      "Audit-led guidance for founders who want clarity before they scale.",
    image:
